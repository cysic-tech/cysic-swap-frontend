...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.CYSIC]: [cysicTokens.cake],
  [ChainId.CYSIC_TESTNET]: [cysicTestnetTokens.cake],
}

// used to construct the list of all pairs we consider by default in the frontend
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  [ChainId.CYSIC]: [cysicTokens.wbnb],
  [ChainId.CYSIC_TESTNET]: [cysicTestnetTokens.wbnb],
}

export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  [ChainId.CYSIC]: [[cysicTokens.cake, cysicTokens.wbnb]],
  [ChainId.CYSIC_TESTNET]: [[cysicTestnetTokens.cake, cysicTestnetTokens.wbnb]],
}
