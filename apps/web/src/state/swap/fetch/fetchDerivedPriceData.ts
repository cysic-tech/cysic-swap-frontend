...
import { SwapLinePairDataTimeWindowEnum as PairDataTimeWindowEnum } from '@pancakeswap/uikit'
...
const SWAP_INFO_BY_CHAIN = {
  [ChainId.CYSIC]: {
    v2: V2_SUBGRAPH_URLS[ChainId.CYSIC],
    v3: V3_SUBGRAPH_URLS[ChainId.CYSIC],
  },
  [ChainId.CYSIC_TESTNET]: {
    v2: V2_SUBGRAPH_URLS[ChainId.CYSIC_TESTNET],
    v3: V3_SUBGRAPH_URLS[ChainId.CYSIC_TESTNET],
  },
  [ChainId.BSC]: {
