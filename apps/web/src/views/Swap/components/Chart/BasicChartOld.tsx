...
import {
  ...
  Flex,
  SwapLineChart,
  SwapLinePairDataTimeWindowEnum,
  Text,
} from '@pancakeswap/uikit'
import { memo, useMemo, useState } from 'react'
import { useFetchPairPricesV3 } from 'state/swap/hooksOld'
...
const BasicChart = ({
  ...
  const [timeWindow, setTimeWindow] = useState<SwapLinePairDataTimeWindowEnum>(0)
