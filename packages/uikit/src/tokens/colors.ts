...
export const lightColors = {
  ...
  destructive: "#FF401A",
  gradientPrimary: "linear-gradient(228.54deg, #00F0FF -13.69%, #7645D9 91.33%)",
...
export const darkColors = {
  ...
  destructive: "#FF401A",
  gradientPrimary: "linear-gradient(228.54deg, #00F0FF -13.69%, #00F0FF 91.33%)",
  gradientBubblegum: "linear-gradient(139.73deg, #000 0%, #000 100%)",
  gradientInverseBubblegum: "linear-gradient(139.73deg, #3D2A54 0%, #313D5C 100%)",
  gradientCardHeader: "linear-gradient(166.77deg, #000 0%, #000 100%)",
  ...
  gradientGold: "linear-gradient(180deg, #FFD800 0%, #FDAB32 100%)",
  gradientBold: "linear-gradient(#53DEE9, #00F0FF)",
};
