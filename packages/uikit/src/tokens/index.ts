...
export const shadows = {
  ...
  success: "0px 0px 0px 1px #11D473, 0px 0px 0px 4px rgba(49, 208, 170, 0.2)",
  warning: "0px 0px 0px 1px #D67E0A, 0px 0px 0px 4px rgba(214, 126, 10, 0.2)",
  danger: "0px 0px 0px 1px #FF401A, 0px 0px 0px 4px rgba(237, 75, 158, 0.2)",
  focus: "0px 0px 0px 1px #00F0FF, 0px 0px 0px 4px rgb(0, 240, 255, 0.6)",
