...
const BSC_FACTORY_ADDRESS = '0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865'

/**
 * To compute Pool address use DEPLOYER_ADDRESSES instead
 */
export const FACTORY_ADDRESSES = {
  [ChainId.CYSIC]: cysicMetadata.PancakeV3Factory,
  [ChainId.CYSIC_TESTNET]: cysicTestnetMetadata.PancakeV3Factory,
  [ChainId.ETHEREUM]: BSC_FACTORY_ADDRESS,
  [ChainId.GOERLI]: BSC_FACTORY_ADDRESS,
  [ChainId.BSC]: BSC_FACTORY_ADDRESS,
  [ChainId.BSC_TESTNET]: BSC_FACTORY_ADDRESS,
  [ChainId.ARBITRUM_ONE]: BSC_FACTORY_ADDRESS,
  [ChainId.ARBITRUM_GOERLI]: '0xBA40c83026213F9cbc79998752721a0312bdB74a',
  [ChainId.POLYGON_ZKEVM]: BSC_FACTORY_ADDRESS,
  ...
  [ChainId.SEPOLIA]: BSC_FACTORY_ADDRESS,
  [ChainId.BASE_SEPOLIA]: BSC_FACTORY_ADDRESS,
  [ChainId.ARBITRUM_SEPOLIA]: BSC_FACTORY_ADDRESS,
} as const satisfies Record<ChainId, Address>

const DEPLOYER_ADDRESS = '0x41ff9AA7e16B8B1a8a8dc4f0eFacd93D02d071c9'

export const DEPLOYER_ADDRESSES = {
  [ChainId.CYSIC]: cysicMetadata.PancakeV3PoolDeployer,
  [ChainId.CYSIC_TESTNET]: cysicTestnetMetadata.PancakeV3PoolDeployer,
...
export const POOL_INIT_CODE_HASHES = {
  [ChainId.CYSIC]: cysicMetadata.InitCodeHash,
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  [ChainId.CYSIC]: cysicMetadata.NonfungiblePositionManager,
